...
class ArxivProcessor(BaseProcessor):
    ...
    def extract_content(self, url: str) -> Tuple[str, str, str]:
        ...
        Tries HTML version first, falls back to abstract page.
        """
        ...
        # Try HTML version first (best for content extraction)
        ...
        try:
            ...
            if content and len(content.strip()) > 500:
                ...
                # Extract title from content (Jina usually includes it)
